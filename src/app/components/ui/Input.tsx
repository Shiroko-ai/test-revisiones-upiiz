...
export default function Input({ type, placeholder, name, ...rest }: InputProps) {
  ...
  return (
    <div className="relative h-11 w-full min-w-[200px] mb-6">
      {error && <p className="absolute bottom-[-20px] left-0 text-xs text-red-500">Correo inválido</p>}
      <input
